                        ...
                        <div className="flex items-center gap-5 ">
                            {
                                user&&postData.likes.includes(user._id) ? 
                                    <AiFillHeart className="text-red-600 cursor-pointer text-3xl" onClick={role === 'user' ? likePostUser:role==='provider' ?likePostProvider:''}/>
                                    :<AiOutlineHeart className="text-black cursor-pointer text-3xl" onClick={role === 'user' ? likePostUser:role=='provider' ?likePostProvider:''}/>
                            }
                            <AiOutlineMessage className="text-black text-3xl cursor-pointer" onClick={handleEvent}/>
